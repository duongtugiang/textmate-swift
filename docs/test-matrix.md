...
| 4 | 58/58 (regexp + scope + parse) + 5/5 (bundles) | ✅ scope 13/13 + parse 4/4 + **bundles 5/5** green (22/58; +12 Swift tests → **107 total**); regexp 41/41 dispositioned above (ICU emulation supersedes Onigmo internals; utility suites follow 4.S5/4.S6) |
